    ...
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text-main)] flex flex-col transition-colors duration-300">
      ...
      <main className="flex-grow pt-32 max-w-6xl mx-auto px-4 w-full pb-16">
        ...
        <div className="flex justify-end gap-3 mb-6">
          <button className="px-4 py-2 rounded-lg border border-zinc-200 dark:border-zinc-850 bg-white dark:bg-zinc-950/60 text-zinc-500 dark:text-zinc-400 hover:text-[#d4af37] hover:border-[#d4af37]/60 hover:bg-[#d4af37]/5 transition-all font-black tracking-widest text-[9px] uppercase font-sans">
            {t.bundle}
          </button>
          <button 
            onClick={() => setShowAllModal(true)}
            className="px-4 py-2 rounded-lg border border-zinc-200 dark:border-zinc-850 bg-white dark:bg-zinc-950/60 text-zinc-500 dark:text-zinc-400 hover:text-[#d4af37] hover:border-[#d4af37]/60 hover:bg-[#d4af37]/5 transition-all font-black tracking-widest text-[9px] uppercase font-sans"
          >
            {t.all}
          </button>
        </div>
                      ...
                      <Link href={`/anime/${activeSeries.slug}`} className="block group w-full h-full">
                        <div className="rounded-2xl overflow-hidden border border-zinc-200 dark:border-zinc-850 bg-white dark:bg-black h-full min-h-[300px] relative flex items-center justify-center shadow-2xl transition-all duration-300 hover:border-[#d4af37]/45">
                          ...
                          <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/15 to-transparent flex flex-col justify-end p-6 z-10 pointer-events-none">
                            <div className="mb-2">
                               <span className="px-2 py-0.5 bg-[#d4af37] text-black text-[9px] font-black uppercase tracking-widest rounded">Featured Selection</span>
                            </div>
                    ...
                    {seriesList
                      ...
                      >
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <h3 className="font-bold text-[var(--text-main)] group-hover:text-[#d4af37] transition-colors">{series.name}</h3>

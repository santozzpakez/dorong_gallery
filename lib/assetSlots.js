...
export const ASSET_GROUPS = [
  ...
  { id: 'mockup-settings', label: '🖥️ Mockup Studio (Adjacent Pictures)' }
]
...
export const ASSET_SLOTS = [
  ...
  { key: 'cover-bg', label: 'Cover BG (Background Website)', group: 'layout', defaultUrl: '' },
  ...
  // ── Mockup Studio Adjacent Pictures ──
  { key: 'mockup-studio-left', label: 'Poster Studio Kiri (Default: Tracer/Overwatch)', group: 'mockup-settings', defaultUrl: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=600&auto=format&fit=crop' },
  { key: 'mockup-studio-right', label: 'Poster Studio Kanan (Default: Sunset/Mountain)', group: 'mockup-settings', defaultUrl: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=600&auto=format&fit=crop' },
